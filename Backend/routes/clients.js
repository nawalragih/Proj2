...
router.post('/register', async (req, res) => {
    ...
    try {
        ...
        const query = `
            INSERT INTO Clients (firstName, lastName, address, creditCardInfo, phoneNumber, email)
            VALUES (?, ?, ?, ?, ?, ?)
        `;
        
        const result = await db.query(query, [firstName, lastName, address, creditCardInfo, phoneNumber, email]);
